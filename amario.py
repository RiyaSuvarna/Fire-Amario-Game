...
pygame.display.set_caption('Fire Amario')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('amario.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound('amario_dies.wav')
    music.play()
...
def game_loop():
    while True:
        ...
        global  HIGH_SCORE
        flames_list = []
        pygame.mixer.music.load('amario_theme.wav')
